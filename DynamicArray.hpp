...
template <class T> class DynamicArray
{
  ...
  public:
    ...
    void Remove(int index)
    {
      ...
      // memcpy(ptr, this->ptr, index * sizeof(T));
      // memcpy(ptr + index, this->ptr + index + 1, (this->count-- - index - 1) * sizeof(T));
      // delete [] this->ptr;
      // this->ptr = ptr;
    ...
    void Resize(size_t newSize)
    {
      ...
      delete [] this->ptr;
      this->ptr = newPtr;
      // this->ptr = (T*) realloc(this->ptr, newSize * sizeof(T));
      // this->size = newSize;
      // if(newSize < this->count) this->count = newSize;
    }
};
